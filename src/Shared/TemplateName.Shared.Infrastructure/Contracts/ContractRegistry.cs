...
using TemplateName.Shared.Abstractions.Contracts;
using TemplateName.Shared.Abstractions.Messaging;
using TemplateName.Shared.Infrastructure.Modules;

namespace TemplateName.Shared.Infrastructure.Contracts;
...
public class ContractRegistry : IContractRegistry
{
    ...
    private void ValidateContract(Type contractType, string path = null)
    {
        ...
        var originalContract = JsonSerializer.Deserialize("{}", originalType);
